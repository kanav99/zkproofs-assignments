...
// TODO: Define member methods here to show that 1) generate a path for a given node 2) you can reach the root of the tree from a given path and leaf

impl<Element> MerkleTree<Element>
where
    Element: Hashable<ShaHasher>,
{
    pub fn generate_path(&self, i: usize) -> Proof<Element> {
        self.prove(i)
    }

    pub fn check_path(&self, proof: Proof<Element>, i: usize) {
